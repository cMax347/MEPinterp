...
class hw_probe:
	...
	def __init__(		self,  phi_pi, val_bands, mp_grid, gamma_scale, kubo_tol, 	
	...
	def iterate_phi(self,hw_min, hw_max, n_hw, mpi_np=1, plot_bandstruct=False):
...
def probe_hw(		hw_min, hw_max, n_hw, 
					phi_pi, val_bands, 
					mp_grid,mpi_np=1, gamma_scale=1,
	...
	phi_job	= hw_probe(	phi_pi, val_bands, mp_grid, gamma_scale, 
	...
	#
	phi_job.iterate_phi(hw_min=0.1, hw_max=6.0,	n_hw	= 5 ,plot_bandstruct=plot_bandstruct, mpi_np=mpi_np)
...
probe_hw(		#parameter space probe density:
				hw_min				=	0					,			
				hw_max				=	6					,
				n_hw				=	7					, 
				#sys para
