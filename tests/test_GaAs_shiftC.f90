program test_FeMn_AHE
	...
	write(*,*)	"	WARNING test not properly implemented yet	"
...
!
	...
	subroutine write_input_cfg_file()
		...
		!
		![wannBase]
		call CFG_add(my_cfg,	"wannBase%seed_name"		,	"GaAs"				,	"seed name of the TB files"						)
		...
		!
		![Laser]
		call CFG_add(my_cfg,	"Laser%N_hw"					,	801				,	"points to probe in interval"					)
		call CFG_add(my_cfg,	"Laser%hw_min"					,	0.0_dp			,	"min energy of incoming light"					)
		call CFG_add(my_cfg,	"Laser%hw_max"					,	8.0_dp			,	"max energy of incoming light"					)
		!~~~~~~~~~~~~		
		!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
